...
- (id)initWithFrame:(CGRect)frame startItem:(AwesomeMenuItem*)startItem optionMenus:(NSMutableArray *)aMenusArray
{
...
- (void)setMenusArray:(NSMutableArray *)aMenusArray
{	
    ...
    _menusArray = [aMenusArray mutableCopy];
